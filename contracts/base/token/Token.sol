...
library Token {
    ...
    uint40 constant TypeERC20 =             0x0000000002; // is ERC20
    uint40 constant TypeERC721 =            0x0000000004; // is ERC721
    uint40 constant TypeERC777 =            0x0000000008; // is ERC777
    uint40 constant TypeERC1155 =           0x0000000010; // is ERC1155
    ...
    uint40 constant FT =                    0x0000000100; // is FT (Coin/ERC20/ERC777)
    uint40 constant NFT =                   0x0000000200; // is NFT (ERC721)
    uint40 constant MT =                    0x0000000400; // is Multi Token (ERC1155)
    ...
    function typeOf(uint40 features_) internal pure returns (uint40) {
...
*/
    ...
    function tt(uint40 features_) internal pure returns (uint40) {
        return features_ & TT;
    }
    function mt(uint40 features_) internal pure returns (bool) {
    ...
    function nft(uint40 features_) internal pure returns (bool) {
    ...
    function ft(uint40 features_) internal pure returns (bool) {
