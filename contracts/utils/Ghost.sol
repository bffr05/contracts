...
bytes32 constant kGhost_Deployer = keccak256("Ghost_Deployer");
...
contract Ghost  {
    ...
    fallback() external virtual {
        ...
        Tools.forwardWithTailMsgSender(_delegate);
    }
